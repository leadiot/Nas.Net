...
namespace Com.Scm.Sys.Notes
{
    ...
    public class NasNotesService : ApiService
    {
        ...
        public NasNotesService(SugarRepository<NotesDao> thisRepository,
        ...
        /// <returns></returns>
        public async Task<ScmPageResultDto<NoteBasicDvo>> GetPagesAsync(NoteSearchRequest request)
        {
