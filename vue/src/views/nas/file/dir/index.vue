...
export default {
	...
	data() {
		return {
			tableName: 'nasfiledir',
			apiObj: this.$API.nasfiledir.page,
			list: [],
			param: {
	...
	methods: {
		...
		async status_item(e, row) {
			this.$SCM.status_item(this, this.$API.nasfiledir.status, row, row.row_status);
		},
		status_list(status) {
			this.$SCM.status_list(this, this.$API.nasfiledir.status, this.selection, status);
		},
		async delete_item(row) {
			this.$SCM.delete_item(this, this.$API.nasfiledir.delete, row);
		},
		delete_list() {
			this.$SCM.delete_list(this, this.$API.nasfiledir.delete, this.selection);
		},
		show_search() {
