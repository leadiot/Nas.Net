...
export default {
	...
	methods: {
		...
		status_list(status) {
			this.$SCM.status_list(this, this.$API.nasfiledoc.status, this.selection, status);
		},
		async delete_item(row) {
			this.$SCM.delete_item(this, this.$API.nasfiledoc.delete, row);
		},
		delete_list() {
			this.$SCM.delete_list(this, this.$API.nasfiledoc.delete, this.selection);
		},
		show_search() {
